...
type openapiSwaggerObject struct {
	...
	Consumes     []string                            `json:"-" yaml:"-"`
	Produces     []string                            `json:"-" yaml:"-"`
...
type openapiComponentsObject struct {
	SecuritySchemes openapiSecurityDefinitionsObject `json:"securitySchemes,omitempty" yaml:"securitySchemes,omitempty"`
	Schemas         openapiComponentsSchemaObject    `json:"schemas,omitempty" yaml:"schemas,omitempty"`
}

type openapiComponentsSchemaObject map[string]openapiSchemaObject
...
type openapiRequestBodyObject struct {
	Description string                          `json:"description,omitempty" yaml:"description,omitempty"`
	Content     map[string]openapiContentObject `json:"content,omitempty" yaml:"content,omitempty"`
}
...
func (s *schemaCore) setRefFromFQN(ref string, reg *descriptor.Registry) error {
	...
	s.Ref = fmt.Sprintf(refSchemasPath, name)
	return nil
}
...
type openapiResponseObject struct {
	...
	Content  map[string]openapiContentObject `json:"content" yaml:"content"`
...
type openapiContentObject struct {
	Schema *openapiSchemaObject `json:"schema,omitempty" yaml:"schema,omitempty"`
}
...
type openapiSchemaObject struct {
	...
	XGovalidator string              `json:"x-govalidator,omitempty" yaml:"x-govalidator,omitempty"`
	AllOf        []map[string]string `json:"allOf,omitempty" yaml:"allOf,omitempty"`
}
